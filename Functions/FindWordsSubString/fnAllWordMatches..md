```ioke
= Table.AddColumn(result, "Custom.1", each 
...
arg5 = List.AnyTrue( List.Transform( {"United States of America", " World", "anc"}, (substring)=> Text.Contains([Country], substring, Comparer.OrdinalIgnoreCase)) ),
arg7 = List.AnyTrue( List.Transform( {" World", "anc"}, (substring)=>  Text.Contains(([Country]), substring, Comparer.OrdinalIgnoreCase))),
